	...
	<div class="container">
		...
		<div class="row">
			<div class="eight columns centered">
				<h3>Recaptcha Fail!</h3>
				<p>We're sorry, but it seems that your reCaptcha guess did not succeed.</p>

				<p>Please try again by going back to the <a href="index.html">key request page</a>, or waiting 3 seconds...</p>
			</div>
		</div>
