...
if (isset($_GET['courseId']))
{
  ...
  {
    $_SESSION['msg']['error'] = "You cannot enable any course other than your own.";
    header("Location: courses.php");
    exit;
  }
}
...
{
  $_SESSION['msg']['error'] = "Course to be enabled was not specified.";
  header("Location: courses.php");
  exit;
}
...
if(isset($_GET['rand']) && $_GET['rand'] == md5(session_id()))
{
  ...
  // Enable the course
  if (setCourseStatus($_GET['courseId'], 'enabled'))
    $_SESSION['msg']['success'] = "The course has been enabled!";
  else
