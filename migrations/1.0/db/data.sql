...
<<<<<<< Updated upstream
INSERT INTO `doclets` VALUES (1,'Check for Tags','Check for the proper use of returns, throw, and param tags.','comtor.analyzers.CheckForTags'),(2,'Comment Average Ratio','Calculate the length of each method\'s comments in a class. If you are not getting full credit, try increasing the length of your comments.','comtor.analyzers.CommentAvgRatio'),(3,'Percentage Methods','Calculate the percentage of commented methods per class.','comtor.analyzers.PercentageMethods'),(4,'Method Interactions','Creates a method call graph for each user defined method. This does not count towards the overall grade.','comtor.analyzers.Interactions'),(5,'Spell Checker','Checks the spelling in comments. (Note:  There may be some words that are spelled correctly, marked incorrect because they are not present in the dictionary.)','comtor.analyzers.SpellCheck'),(6,'Pre and Post Check','Check for the presence of pre and post condition tags. The _text tags are used for text based descriptions while the _exp tags are used for expressions.','comtor.analyzers.PreAndPostCheck'),(7,'Reading Level','Calculates various sentence and word metrics, as well as the Flesch-Kincaid Reading Level of the comments.','comtor.analyzers.ReadingLevel');
=======
INSERT INTO `doclets` VALUES (1,'Check for Tags','Validates the proper use of the @return, @throw, and @param tags in method comments.','comtor.analyzers.CheckForTags'),(2,'Comment Average Ratio','Calculate the length of each method\'s comments in a class. If you are not getting full credit, try increasing the length of your comments.','comtor.analyzers.CommentAvgRatio'),(3,'Percentage Methods','Calculate the percentage of commented methods per class.','comtor.analyzers.PercentageMethods'),(4,'Method Interactions','Creates a method call graph for each user defined method. This does not count towards the overall grade.','comtor.analyzers.Interactions'),(5,'Spell Checker','Checks the spelling in comments. (Note:  There may be some words that are spelled correctly, marked incorrect because they are not present in the dictionary.)','comtor.analyzers.SpellCheck'),(6,'Pre and Post Check','Check for the presence of pre and post condition tags. The _text tags are used for text based descriptions while the _exp tags are used for expressions.','comtor.analyzers.PreAndPostCheck');
>>>>>>> Stashed changes
