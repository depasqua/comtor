 ...
 **************************************************************************/
package org.comtor.examples;

import java.util.ArrayList;
import java.util.Collections;

/**
 * The <code>LongestCommonSubstringExample</code> class houses a single 
 ...
 */
public class LongestCommonSubstringExample
{
    ...
    * @param line
    */
   public ArrayList<String> lcss(String data, String line)
   {
      return null;
   }
