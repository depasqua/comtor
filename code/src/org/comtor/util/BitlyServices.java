...
public class BitlyServices {
	/**
	 * Returns a Bitly (bitly.com) shortened url.
	 *
	 * @param longUrl A String representation containing a valid url to be shortened.
	 * @return A String representation of the shortened URL via Bitly.
	 */
