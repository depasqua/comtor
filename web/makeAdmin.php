...
if($_GET['confirm'] == "yes")
{
	...
	$message = "The account is now an administrator!";
}
else {
	$message = "Are you sure you want to make this account an administrator? <a href=\"makeAdmin.php?id=$userID&confirm=yes\">Yes</a> <a href=\"index.php\">No</a>";
}
?>
