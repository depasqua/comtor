...
<p>
As a result, there is little incentive to offer meaningful
...
<p>
Comment Mentor is <span style="font-weight: bold;">not</span> a compiler. It doesn't alter your
source code, only derives measurements from comments that are
encoded a certain way.
</p>

<p>
Comment Mentor does <span style="font-weight: bold;">not</span> assess the quality of other
